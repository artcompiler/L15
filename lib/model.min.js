...
Assert.messages[1005]="Misplaced thousands separator.";Assert.messages[1006]="Unexpected expression: %1";var h=Assert.message;a.create=n.create=function C(b,c){assert(b,"Model.create() called with invalid argument "+b);if(b instanceof a)return c&&(b.location=c),b;var e;if(b instanceof Array)return e=[],forEach(b,function(a){e.push(C(a,c))}),e;if(!(this instanceof a))return(new a).create(b,c);e=C(this);e.location=c;b="string"===typeof b?q(b,a.env).expr():JSON.parse(JSON.stringify(b));forEach(keys(a.fn),
function(b,c){n.hasOwnProperty(b)||(n[b]=function(){var c=a.fn[b];if(1<arguments.length&&arguments[1]instanceof a)return c.apply(this,arguments);for(var e=[this],d=0;d<arguments.length;d++)e.push(arguments[d]);return c.apply(this,e)})});forEach(keys(b),function(a,c){e[a]=b[a]});return e};a.fromLaTex=n.fromLaTex=function(b){assert("string"===typeof b,"Model.prototype.fromLaTex");return this?this.create(b):a.create(b)};n.toLaTex=function(a){return z(a)};var b={ADD:"+",SUB:"-",MUL:"times",DIV:"div",
...
BINOM:"binom",ROW:"row",COL:"col",COLON:"colon",MATRIX:"matrix",FORMAT:"format"};forEach(keys(b),function(c,e){a[c]=b[c]});var e={};e[b.ADD]="+";e[b.SUB]="-";e[b.MUL]="\\times";e[b.DIV]="\\div";e[b.FRAC]="\\frac";e[b.EQL]="=";e[b.ATAN2]="\\atan2";e[b.POW]="^";e[b.SUBSCRIPT]="_";e[b.PM]="\\pm";e[b.SIN]="\\sin";e[b.COS]="\\cos";e[b.TAN]="\\tan";e[b.ARCSIN]="\\arcsin";e[b.ARCCOS]="\\arccos";e[b.ARCTAN]="\\arctan";e[b.SEC]="\\sec";e[b.COT]="\\cot";e[b.CSC]="\\csc";e[b.LN]="\\ln";e[b.COMMA]=",";e[b.M]=
"\\M";e[b.BINOM]="\\binom";e[b.COLON]="\\colon";a.fold=function v(a,c){var l=[],e;forEach(a.args,function(a){l.push(v(a,c))});a.args=l;switch(a.op){case b.VAR:if(e=c[a.args[0]])a=e}return a};var z=function Va(a){var c="";if("string"===typeof a)c=a;else if("number"===typeof a)c=a;else if("object"===typeof a){for(var d=[],h=0;h<a.args.length;h++)d[h]=Va(a.args[h]);switch(a.op){case b.VAR:case b.CST:case b.NUM:c=a.args[0];break;case b.SUB:c=1===a.args.length?e[a.op]+" "+d[0]:d[0]+" "+e[a.op]+" "+d[1];
break;case b.DIV:case b.PM:case b.EQL:c=d[0]+" "+e[a.op]+" "+d[1];break;case b.POW:var h=a.args[0],k=a.args[1];if(h.args&&2===h.args.length||k.args&&2===k.args.length)if(h.op===b.ADD||h.op===b.SUB||h.op===b.MUL||h.op===b.DIV||h.op===b.SQRT)d[0]=" ("+d[0]+") ";c="{"+d[0]+"^{"+d[1]+"}}";break;case b.SIN:case b.COS:case b.TAN:case b.ARCSIN:case b.ARCCOS:case b.ARCTAN:case b.SEC:case b.COT:case b.CSC:case b.LN:case b.M:c="{"+e[a.op]+"{"+d[0]+"}}";break;case b.FRAC:c="\\dfrac{"+d[0]+"}{"+d[1]+"}";break;
case b.BINOM:c="\\binom{"+d[0]+"}{"+d[1]+"}";break;case b.SQRT:switch(d.length){case 1:c="\\sqrt{"+d[0]+"}";break;case 2:c="\\sqrt["+d[0]+"]{"+d[1]+"}"}break;case b.VEC:c="\\vec{"+d[0]+"}";break;case b.MUL:var n,c="";forEach(a.args,function(h,k){if(h.args&&2<=h.args.length){if(h.op===b.ADD||h.op===b.SUB)d[k]="("+d[k]+")";0!==k&&"number"===typeof h&&(c+=e[a.op]+" ")}else h.op===b.PAREN||h.op===b.VAR||h.op===b.CST||"number"===typeof n&&"number"!==typeof h||0!==k&&(c+=" "+e[a.op]+" ");c+=d[k];n=h});
break;case b.ADD:case b.COMMA:forEach(d,function(b,d){c=0===d?b:c+" "+e[a.op]+" "+b});break;default:assert(!1,"unimplemented eval operator")}}else assert(!1,"invalid expression type");return c},q=function(d,e){function l(a,b){return{op:a,args:b}}function k(g,b,c){var d=a.option("ignoreTrailingZeros"),e=g.toString();g="";var f,S,l,m,n=!1,p="integer",q,r;for(f=0;f<e.length;f++)","===(S=e.charAt(f))?(n&&l!==f-4&&assert(!1,h(1005)),l=f,n=!0):("."===S?(p="decimal",n&&l!==f-4&&assert(!1,h(1005)),n=!1,"0"===
g&&(q=!0),m=f-1):"decimal"===p&&"0"!==S&&(m=f),g+=S);n&&l!==f-4&&assert(!1,h(1005));void 0!==m&&(m+1<g.length&&(r=!0),d&&(g=g.substring(0,m+1)));g=new BigDecimal(g);b&&(b=option("decimalPlaces"),!c||g.scale()>b)&&(g=g.setScale(b,BigDecimal.ROUND_HALF_UP));return{op:a.NUM,args:[String(g)],hasThousandsSeparator:n,numberFormat:p,hasLeadingZero:q,hasTrailingZero:r}}function n(g,b){return r(a.MUL,g,b)}function q(g,b){assert(1===b.length,"Wrong number of arguments for unary node");return g===a.ADD?b[0]:
l(g,b)}function r(a,b,c){assert(1<b.length,"Too few argument for binary node");var d=[];forEach(b,function(b){c&&b.op===a?d=d.concat(b.args):d.push(b)});return l(a,d)}function m(){p=Ka;Ka=T;p===T&&(p=A.start())}function s(a){var b=p;b!==a&&(a=String.fromCharCode(a),b=b?String.fromCharCode(b):"EOS",assert(!1,h(1001,[a,b])));m()}function t(){var g,b;switch(b=p){case 65:case 97:case G:g=[A.lexeme()];m();p===H&&(m(),g.push(t()));g=l(a.VAR,g);break;case La:g=k(A.lexeme());m();!c()||(e=p)!==D&&e!==B||(m(),
g=q(f[e],[g]));break;case U:case V:var d;s(b);g=E();a.option("allowInterval")?s(d=p===I?I:J):s(d=b===U?I:J);g.lbrk=b;g.rbrk=d;!a.option("allowInterval")||2!==g.args.length||b!==U&&b!==V||d!==I&&d!==J?g.op===a.COMMA&&(g.op=a.LIST):g.op=a.INTERVAL;break;case da:g=u();break;case Ma:m();b=u();d=[];for(d.push(z());p===K;)m(),d.push(z());d=l(f[K],d);s(ea);u();0<=b.args[0].indexOf("matrix")?g=l(a.MATRIX,[d]):assert(!1,"Unrecognized LaTeX name");break;case x:s(x);g=W();s(x);g=q(a.ABS,[g]);break;case X:m();
g=u();b=u();g=l(a.FRAC,[g,b]);g.isFraction=!0;break;case fa:m();b=u();d=u();g=q(a.FACT,[b]);b=r(a.POW,[r(a.MUL,[q(a.FACT,[d]),q(a.FACT,[r(a.ADD,[b,ga(d)])])]),w]);g=r(a.MUL,[g,b]);g.isBinomial=!0;break;case ha:m();switch(p){case V:s(V);g=E();s(J);b=u();g=l(a.POW,[b,g,w]);break;case da:b=u();g=l(a.POW,[b,l(a.NUM,["2"]),w]);break;default:assert(!1,h(1001,["{ or (",String.fromCharCode(p)]))}break;case ia:m();g=u();g=l(a.VEC,[g]);break;case ja:case ka:case la:m();var e;for(g=[];p===F;)m(),g.push(y());
1===g.length&&g[0].op===a.NUM&&"-1"===g[0].args[0]?(b="arc"+f[b],g=[]):b=f[b];g.unshift(l(b,[t()]));return 1<g.length?l(a.POW,g):g[0];case ma:case na:case oa:case pa:case qa:case ra:m();for(g=[];p===F;)m(),g.push(y());g.unshift(l(f[b],[t()]));return 1<g.length?l(a.POW,g):g[0];case sa:return m(),l(a.LOG,[l(a.VAR,["e"]),t()]);case ta:return m(),l(a.LOG,[l(a.NUM,["10"]),t()]);case ua:return m(),g=[],p===H?(m(),g.push(t())):g.push(l(a.VAR,["e"])),g.push(t()),l(a.LOG,g);case va:return m(),g=[],s(H),g.push(t()),
g.push(t()),l(f[b],g);case wa:case xa:case ya:return m(),g=[],p===H&&(m(),g.push(t()),s(F),g.push(t())),g.push(E()),l(f[b],g);case za:return m(),l(a.EXISTS,[L()]);case Aa:return m(),l(a.FORALL,[E()]);case Ba:return m(),l(a.EXP,[W()]);case Na:return m(),l(a.M,[Ca()]);case Da:return m(),l(a.FORMAT,[u()]);default:assert(!1,h(1006,[A.lexeme()])),g=void 0}return g}function z(){var a=[];for(a.push(L());p===M;)m(),a.push(L());return l(f[M],a)}function u(){s(da);var a=E();s(Oa);return a}function y(){var g,
b;switch(g=p){case D:m();b=y();break;case B:m();b=ga(y());break;case N:case F:m();b=y();b=l(f[g],[b]);break;default:for(b=[t()];(g=p)===F;){m();var d;d=b[0];d=d.op!==a.VAR?!1:(d=a.env[d.args[0]])&&d.name?!0:!1;!(d||c()&&Pa(b[0]))||(g=p)!==D&&g!==B?(d=y(),!c()||(g=p)!==D&&g!==B?d.op===a.VAR&&"\\circ"===d.args[0]?b=[n([b[0],l(a.VAR,["\\degree"])])]:b.push(d):(m(),b.push(q(f[g],[d])))):(m(),b.push(q(f[g],[Wa])))}g=1<b.length?l(a.POW,b):b[0];switch(p){case Qa:m();g=l(a.PERCENT,[g]);break;case Ra:m(),
g=l(a.FACT,[g])}b=g}return b}function Sa(){for(var b=[y()];p===H;)m(),b.push(y());return 1<b.length?l(a.SUBSCRIPT,b):b[0]}function Pa(b){return b.op!==a.VAR?!1:(b=a.env[b.args[0]])&&b.mass?!0:!1}function Ca(){var b,d,e=!1,f,h=[];d=Sa();for(h=d.op!==a.MUL||d.isBinomial?[d]:d.args;(b=p)&&!Ta(b)&&!Ea(b)&&b!==Y&&b!==Z&&b!==Oa&&b!==I&&b!==J&&b!==O&&b!==P&&b!==x&&b!==K&&b!==M&&b!==ea;){f=e;e=!1;if(b===Q||b===$||b===Fa)m(),e=!0;d=Sa();b===$?d=l(a.POW,[d,w]):b===Fa&&(b=h.pop(),d=l(a.FRAC,[b,d]),d.isFraction=
!0,e=f);if(f=c())if(f=b===U)f=h[h.length-1],assert(!0,"Internal error in 'isVar()'"),f=f.op!==a.VAR?!1:void 0===f?!0:"M"===f.args[0];if(f)h.pop(),d=q(a.M,[d]);else{if(f=!e)if(f=0<h.length)f=[h[h.length-1],d],f=f[0].op===a.NUM&&f[1].op===a.FRAC&&f[1].args[0].op===a.NUM?!0:!1;if(f)b=h.pop(),Ga(b)&&(d=r(a.MUL,[w,d])),d=r(a.ADD,[b,d]),d.isMixedFraction=!0;else{if(f=b===Q)if(f=0<h.length)if(f=e){var k=[h[h.length-1],d];1===k.length?f=k[0].op===a.NUM&&(1===k[0].args[0].length||1===k[0].args[0].indexOf("."))||
k[0].op===a.POW&&k[0].args[0].op===a.NUM&&"10"===k[0].args[0].args[0]&&"integer"===k[0].args[1].numberFormat?!0:!1:2===k.length?(f=k[0],k=k[1],f=f.op!==a.NUM||1!==f.args[0].length&&1!==f.args[0].indexOf(".")||k.op!==a.POW||k.args[0].op!==a.NUM||"10"!==k.args[0].args[0]||"integer"!==k.args[1].numberFormat?!1:!0):f=void 0}f&&(b=h.pop(),Ga(b)&&(d=r(a.MUL,[w,d])),d=r(a.MUL,[b,d]),d.isScientific=!0)}}d.op!==a.MUL||d.isScientific||d.isBinomial?h.push(d):h=h.concat(d.args)}if(1<h.length){if(c()&&Pa(h[1]))return h[0].op===
...
return{start:function(){var e;for(f="";c<b.length;)switch(e=b.charCodeAt(c++)){case 32:case 9:case 10:case 13:continue;case 38:if(0===b.substring(c).indexOf("nbsp;")){c+=5;continue}return M;case 92:f+=String.fromCharCode(e);if(92===b.charCodeAt(c))return c++,K;e=b.charCodeAt(c++);if(36===e)f=String.fromCharCode(e);else if(37===e)f+=String.fromCharCode(e);else if(0<=[32,58,59,44,33].indexOf(e))f="\\ ";else{for(;97<=e&&122>=e||65<=e&&90>=e;)f+=String.fromCharCode(e),e=b.charCodeAt(c++);c--}e=k[f];if(void 0===
e)e=G;else if(269===e){for(e=b.charCodeAt(c++);123!==e;)e=b.charCodeAt(c++);f="";for(e=b.charCodeAt(c++);125!==e;)e=String.fromCharCode(e),"&"===e&&0===b.substring(c).indexOf("nbsp;")?c+=5:" "!==e&&"\t"!==e&&(f+=e),e=b.charCodeAt(c++);e=a.option("ignoreText")?null:G}if(null!==e)return e;f="";continue;case 45:if(62===b.charCodeAt(c))return c++,O;case 33:case 37:case 40:case 41:case 42:case 43:case 44:case 47:case 58:case 61:case 91:case 93:case 94:case 95:case 123:case 124:case 125:return f+=String.fromCharCode(e),
e;case 36:return f+=String.fromCharCode(e),G;case 60:return 61===b.charCodeAt(c)?(c++,aa):P;case 62:return 61===b.charCodeAt(c)?(c++,ca):ba;default:if(65<=e&&90>=e||97<=e&&122>=e||39===e)return d(e);if(46===e||48<=e&&57>=e){for(;48<=e&&57>=e||46===e||a.option("allowThousandsSeparator")&&44===e;)f+=String.fromCharCode(e),e=b.charCodeAt(c++);c--;return La}assert(!1,h(1004,[String.fromCharCode(e),e]));return 0}return 0},lexeme:function(){return f},pos:function(){return c}}}(d);return{expr:function(){if(p=
A.start()){var a=E();assert(!p,h(1003,[A.pos(),A.lexeme()]));return a}return k("dummy")}}};return a}();
