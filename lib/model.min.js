...
{op:a.NUM,args:["2"]},{op:a.NUM,args:["-1"]}]};break;default:assert(!1,g(1001,["{ or (",String.fromCharCode(l)]))}break;case H:case I:case J:case K:case L:case M:case N:c();h={op:k[b],args:[e()]};break;default:assert(!1,"Model.primaryExpr() unexpected expression kind"),h=void 0}b=h}return b}function R(){for(var b=[f()];l===X;)c(),b.push(f());return 1<b.length?{op:a.POW,args:b}:b[0]}function r(){for(var b,d,e=[R()];(b=l)&&!T(b)&&b!==z&&b!==O&&b!==V&&b!==E&&b!==x;)b!==P&&b!==A||c(),d=R(),b===A&&(d=
{op:a.POW,args:[d,{op:a.NUM,args:["-1"]}]}),e.push(d);return 1<e.length?{op:a.MUL,args:e}:e[0]}function S(b){if("number"===typeof b)return-b;if(1===b.args.length){if(b.op===a.SUB)return b.args[0];if(b.op===a.ADD)return b.args[0]=S(b.args[0]),b;if(b.op===a.NUM||b.op===a.VAR)return{op:a.MUL,args:[{op:a.NUM,args:["-1"]},b]}}else if(2===b.args.length)return{op:a.SUB,args:[b]};assert(!1,"Unhandled case in negate() op="+b.op+" n.args.length="+b.args.length);return{op:a.SUB,args:[b]}}function T(a){return a===
