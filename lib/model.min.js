...
PAREN:"()",HIGHLIGHT:"hi",LT:"lt",LE:"le",GT:"gt",GE:"ge",INTERVAL:"interval",EXISTS:"exists",IN:"in",FORALL:"forall",LIM:"lim",EXP:"exp",TO:"to",SUM:"sum",INT:"int",PROD:"prod",PERCENT:"%",M:"M",RIGHTARROW:"->",FACT:"fact",BINOM:"binom",ROW:"row",COL:"col"};forEach(keys(a),function(c,d){b[c]=a[c]});var e={};e[a.ADD]="+";e[a.SUB]="-";e[a.MUL]="\\times";e[a.DIV]="\\div";e[a.FRAC]="\\frac";e[a.EQL]="=";e[a.ATAN2]="\\atan2";e[a.POW]="^";e[a.SUBSCRIPT]="_";e[a.PM]="\\pm";e[a.SIN]="\\sin";e[a.COS]="\\cos";
e[a.TAN]="\\tan";e[a.SEC]="\\sec";e[a.COT]="\\cot";e[a.CSC]="\\csc";e[a.LN]="\\ln";e[a.COMMA]=",";e[a.M]="\\M";e[a.BINOM]="\\binom";var l=function B(b){var c="";if("string"===typeof b)c=b;else if("number"===typeof b)c=b;else if("object"===typeof b){for(var d=[],f=0;f<b.args.length;f++)d[f]=B(b.args[f]);switch(b.op){case a.VAR:case a.CST:case a.NUM:c=b.args[0];break;case a.SUB:c=1===b.args.length?e[b.op]+" "+d[0]:d[0]+" "+e[b.op]+" "+d[1];break;case a.DIV:case a.PM:case a.EQL:c=d[0]+" "+e[b.op]+" "+
d[1];break;case a.POW:var f=b.args[0],k=b.args[1];if(f.args&&2===f.args.length||k.args&&2===k.args.length)if(f.op===a.ADD||f.op===a.SUB||f.op===a.MUL||f.op===a.DIV||f.op===a.SQRT)d[0]=" ("+d[0]+") ";c="{"+d[0]+"^{"+d[1]+"}}";break;case a.SIN:case a.COS:case a.TAN:case a.SEC:case a.COT:case a.CSC:case a.LN:case a.M:c="{"+e[b.op]+"{"+d[0]+"}}";break;case a.FRAC:c="\\dfrac{"+d[0]+"}{"+d[1]+"}";break;case a.BINOM:c="\\binom{"+d[0]+"}{"+d[1]+"}";break;case a.SQRT:switch(d.length){case 1:c="\\sqrt{"+d[0]+
"}";break;case 2:c="\\sqrt["+d[0]+"]{"+d[1]+"}"}break;case a.MUL:var l,c="";forEach(b.args,function(f,k){if(f.args&&2<=f.args.length){if(f.op===a.ADD||f.op===a.SUB)d[k]="("+d[k]+")";0!==k&&"number"===typeof f&&(c+=e[b.op]+" ")}else f.op===a.PAREN||f.op===a.VAR||f.op===a.CST||"number"===typeof l&&"number"!==typeof f||0!==k&&(c+=" "+e[b.op]+" ");c+=d[k];l=f});break;case a.ADD:case a.COMMA:forEach(d,function(a,d){c=0===d?a:c+" "+e[b.op]+" "+a});break;default:assert(!1,"unimplemented eval operator")}}else assert(!1,
...
args:d}}function k(){m=xa;xa=K;m===K&&(m=u.start())}function p(b){var a=m;a!==b&&(b=String.fromCharCode(b),a=a?String.fromCharCode(a):"EOS",assert(!1,n(1001,[b,a])));k()}function q(){var g,a;switch(a=m){case 65:case 97:case C:g=[u.lexeme()];k();m===D&&(k(),g.push(q()));g={op:"var",args:g};break;case ya:g={op:"num",args:[u.lexeme()]};k();break;case za:case L:p(a);var c=x();p(g=m===Y?Y:M);2===c.args.length||a!==L&&g!==M||assert(!1,n(1002));c.lbrk=a;c.rbrk=g;g=c;break;case Z:g=r();break;case Aa:k();
a=r().args[0];g=[];for(g.push(Ba());m===E;)k(),g.push(Ba());g={op:a,args:[1<g.length?{op:h[E],args:g}:g[0]]};p($);r();break;case N:p(N);a=O();p(N);g=e(b.ABS,[a]);break;case P:k();g=r();c=r();g={op:b.MUL,args:[g,{op:b.POW,args:[c,{op:b.NUM,args:["-1"]}]}]};break;case aa:k();g=r();c=r();a=e(b.FACT,[g]);g=l(b.MUL,[e(b.FACT,[c]),e(b.FACT,[l(b.ADD,[g,ba(c)])])]);g={op:b.MUL,args:[a,{op:b.POW,args:[g,{op:b.NUM,args:["-1"]}]}]};break;case ca:k();switch(m){case L:p(L);a=x();p(M);g=r();g={op:b.POW,args:[g,
a,{op:b.NUM,args:["-1"]}]};break;case Z:g=r();g={op:b.POW,args:[g,{op:b.NUM,args:["2"]},{op:b.NUM,args:["-1"]}]};break;default:assert(!1,n(1001,["{ or (",String.fromCharCode(m)]))}break;case da:case ea:case fa:case ga:case ha:case ia:k();for(g=[];m===Q;)k(),g.push(y());g.unshift({op:h[a],args:[q()]});return 1<g.length?{op:b.POW,args:g}:g[0];case ja:return k(),{op:b.LOG,args:[{op:b.VAR,args:["e"]},q()]};case ka:return k(),{op:b.LOG,args:[{op:b.NUM,args:["10"]},q()]};case la:return k(),g=[],m===D?(k(),
g.push(q())):g.push({op:b.VAR,args:["e"]}),g.push(q()),{op:b.LOG,args:g};case ma:return k(),g=[],p(D),g.push(q()),g.push(q()),{op:h[a],args:g};case na:case oa:case pa:return k(),g=[],m===D&&(k(),g.push(q()),p(Q),g.push(q())),g.push(x()),{op:h[a],args:g};case qa:return k(),{op:b.EXISTS,args:[z()]};case ra:return k(),{op:b.FORALL,args:[x()]};case sa:return k(),{op:b.EXP,args:[O()]};case Ca:return k(),{op:b.M,args:[ta()]};default:assert(!1,"Model.primaryExpr() unexpected expression kind "+u.lexeme()),
g=void 0}return g}function r(){p(Z);var b=x();p(Da);return b}function y(){var a,c;switch(a=m){case F:k();c=y();break;case A:case G:k();c=y();c={op:h[a],args:[c]};break;default:a=q();switch(m){case Ea:k();a={op:b.PERCENT,args:[a]};break;case Fa:k(),a={op:b.FACT,args:[a]}}c=a}return c}function s(){var a;for(a=[y()];m===D;)k(),a.push(y());a=1<a.length?{op:b.SUBSCRIPT,args:a}:a[0];for(var c=[a];(a=m)===Q;){k();var d;d=c[0];d=d.op!==b.VAR?!1:(d=b.env[d.args[0]])&&d.name?!0:!1;!(d||b.env.Au&&Ga(c[0]))||
(a=m)!==F&&a!==A?(d=y(),!b.env.Au||(a=m)!==F&&a!==A?c.push(d):(k(),c.push(e(a,[d])))):(k(),c.push(e(a,[f(1)])))}return 1<c.length?{op:b.POW,args:c}:c[0]}function Ga(a){return a.op!==b.VAR?!1:(a=b.env[a.args[0]])&&a.mass?!0:!1}function ta(){for(var a,c,d=[s()];(a=m)&&!Ha(a)&&!ua(a)&&a!==R&&a!==S&&a!==Da&&a!==Y&&a!==M&&a!==H&&a!==I&&a!==N&&a!==E&&a!==J&&a!==$;){a!==T&&a!==U||k();c=s();if(a===U)c={op:b.POW,args:[c,{op:b.NUM,args:["-1"]}]};else{var f;if(f=b.env.Au)if(f=a===za)f=d[d.length-1],assert(!0,
"Internal error in 'isVar()'"),f=f.op!==b.VAR?!1:void 0===f?!0:"M"===f.args[0];f&&(d.pop(),c=e(b.M,[c]))}d.push(c)}return 1<d.length?b.env.Au&&Ga(d[1])?d[0].op===b.NUM?(a=[d.shift(),l(b.ADD,d)],l(b.MUL,a,void 0)):l(b.ADD,d):{op:b.MUL,args:d}:d[0]}function ba(a){if("number"===typeof a)return-a;if(1===a.args.length){if(a.op===b.SUB)return a.args[0];if(a.op===b.ADD)return a.args[0]=ba(a.args[0]),a}else if(a.op===b.MUL)return a.args.unshift({op:b.NUM,args:["-1"]}),a;return{op:b.MUL,args:[{op:b.NUM,args:["-1"]},
a]}}function Ha(a){return a===F||a===A||a===G}function O(){for(var a=ta(),c;Ha(c=m);){k();var d=ta();switch(c){case G:a={op:b.PM,args:[a,d]};break;case A:d=ba(d);default:a={op:b.ADD,args:[a,d]}}}return a}function ua(a){return a===I||a===V||a===W||a===X||a===va||a===wa}function z(){if(m===S)var a={op:b.VAR,args:["_"]};else{for(var a=m,c=ua(a)?{op:b.VAR,args:["_"]}:O();ua(a=m);){k();var d=0===m?{op:b.VAR,args:["_"]}:O();switch(a){default:c={op:h[a],args:[c,d]}}}a=c}for(var f;(f=m)===S||f===H;)k(),c=
0===m?{op:b.VAR,args:["_"]}:z(),a={op:h[f],args:[a,c]};return a}function x(){for(var a=z(),b=[a];m===R;)k(),b.push(z());return 1<b.length?{op:h[R],args:b}:a}function Ba(){var a=[];for(a.push(z());m===J;)k(),a.push(z());return 1<a.length?{op:h[J],args:a}:a[0]}var K=0,F=43,Q=94,D=95,ea=261,ha=264,ia=265,U=47,S=61,P=256,ja=263,Z=123,N=124,L=91,za=40,T=42,ya=48,G=258,Da=125,M=93,Y=41,ga=262,da=259,ca=257,A=45,fa=260,C=97,R=44,ka=267,la=268,I=270,V=271,W=272,X=273,qa=274,va=275,ra=276,ma=277,sa=278,wa=
279,na=280,oa=281,pa=282,Ea=37,Ca=283,H=284,Fa=33,aa=285,E=286,J=287,Aa=288,$=289,h=[],m=K,xa=K;h[P]=a.FRAC;h[ca]=a.SQRT;h[F]=a.ADD;h[A]=a.SUB;h[G]=a.PM;h[Q]=a.POW;h[T]=a.MUL;h[U]=a.FRAC;h[da]=a.SIN;h[ea]=a.COS;h[fa]=a.TAN;h[ga]=a.SEC;h[ha]=a.COT;h[ia]=a.CSC;h[ja]=a.LN;h[ka]=a.LG;h[la]=a.LOG;h[S]=a.EQL;h[R]=a.COMMA;h[269]=a.TEXT;h[I]=a.LT;h[V]=a.LE;h[W]=a.GT;h[X]=a.GE;h[qa]=a.EXISTS;h[va]=a.IN;h[ra]=a.FORALL;h[ma]=a.LIM;h[sa]=a.EXP;h[wa]=a.TO;h[na]=a.SUM;h[oa]=a.INT;h[pa]=a.PROD;h[Ca]=a.M;h[H]=a.RIGHTARROW;
h[Fa]=a.FACT;h[aa]=a.BINOM;h[E]=a.ROW;h[J]=a.COL;var u=function(a){function b(d){var e=String.fromCharCode(d);for(f+=e;97<=d&&122>=d||65<=d&&90>=d;){d=a.charCodeAt(c++);var e=String.fromCharCode(d),k=f+e;if(!some(h,function(a){return 0===a.indexOf(k)}))break;f+=e}for(;39===d;)d=a.charCodeAt(c++),e=String.fromCharCode(d),f+=e;c--;return C}var c=0,f="",e=[];e["\\cdot"]=T;e["\\times"]=T;e["\\div"]=U;e["\\dfrac"]=P;e["\\frac"]=P;e["\\sqrt"]=ca;e["\\pm"]=G;e["\\sin"]=da;e["\\cos"]=ea;e["\\tan"]=fa;e["\\sec"]=
ga;e["\\cot"]=ha;e["\\csc"]=ia;e["\\ln"]=ja;e["\\lg"]=ka;e["\\log"]=la;e["\\left"]=null;e["\\right"]=null;e["\\big"]=null;e["\\Big"]=null;e["\\bigg"]=null;e["\\Bigg"]=null;e["\\text"]=269;e["\\textrm"]=269;e["\\textit"]=269;e["\\textbf"]=269;e["\\lt"]=I;e["\\le"]=V;e["\\gt"]=W;e["\\ge"]=X;e["\\exists"]=qa;e["\\in"]=va;e["\\forall"]=ra;e["\\lim"]=ma;e["\\exp"]=sa;e["\\to"]=wa;e["\\sum"]=na;e["\\int"]=oa;e["\\prod"]=pa;e["\\%"]=Ea;e["\\rightarrow"]=H;e["\\binom"]=aa;e["\\begin"]=Aa;e["\\end"]=$;var h=
keys(d);return{start:function(){var d;for(f="";c<a.length;)switch(d=a.charCodeAt(c++)){case 32:case 9:case 10:case 13:continue;case 38:return J;case 92:f+=String.fromCharCode(d);if(92===a.charCodeAt(c))return c++,E;d=a.charCodeAt(c++);if(36===d)f=String.fromCharCode(d);else if(37===d)f+=String.fromCharCode(d);else{for(;97<=d&&122>=d||65<=d&&90>=d;)f+=String.fromCharCode(d),d=a.charCodeAt(c++);c--}d=e[f];if(void 0===d)d=C;else if(269===d){for(d=a.charCodeAt(c++);123!==d;)d=a.charCodeAt(c++);f="";for(d=
a.charCodeAt(c++);125!==d;)d=String.fromCharCode(d),f+=d,d=a.charCodeAt(c++);d=C}if(d)return d;f="";continue;case 45:if(62===a.charCodeAt(c))return c++,H;case 33:case 37:case 40:case 41:case 42:case 43:case 44:case 47:case 61:case 91:case 93:case 94:case 95:case 123:case 124:case 125:return f+=String.fromCharCode(d),d;case 36:return f+=String.fromCharCode(d),C;case 60:return 61===a.charCodeAt(c)?(c++,V):I;case 62:return 61===a.charCodeAt(c)?(c++,X):W;default:if(65<=d&&90>=d||97<=d&&122>=d)return b(d);
if(46===d||48<=d&&57>=d){for(;48<=d&&57>=d||46===d;)f+=String.fromCharCode(d),d=a.charCodeAt(c++);c--;return ya}assert(!1,n(1004,[String.fromCharCode(d),d]));return 0}return 0},lexeme:function(){return f},pos:function(){return c}}}(c);return{expr:function(){m=u.start();var a=x();assert(!m,n(1003,[u.pos(),u.lexeme()]));return a}}};return b}();
