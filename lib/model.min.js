...
String.fromCharCode(d),d;default:if(65<=d&&90>=d||97<=d&&122>=d)return c+=String.fromCharCode(d),t;if(46===d||48<=d&&57>=d){for(;48<=d&&57>=d||46===d;)c+=String.fromCharCode(d),d=a.charCodeAt(b++);b--;return Q}assert(!1,"scan.start(): c="+d);return 0}return 0},lexeme:function(){return c}}}(a);return{expr:function(){m=s.start();return y()}}};return b}();
