...
{op:"var",args:[s.lexeme()]};c();break;case 97:a={op:"var",args:[s.lexeme()]};c();break;case pa:a={op:"num",args:[s.lexeme()]};c();break;case wa:case y:d(q);a=u();d(tk2=m===J?J:z);2===a.args.length||q!==y&&tk2!==z||assert(!1,f(1002));a.lbrk=q;a.rbrk=tk2;break;case K:a=n();break;case A:c();q=n();a=n();a={op:b.MUL,args:[q,{op:b.POW,args:[a,{op:b.NUM,args:["-1"]}]}]};break;case L:c();switch(m){case y:d(y);q=u();d(z);a=n();a={op:b.POW,args:[a,q,{op:b.NUM,args:["-1"]}]};break;case K:a=n();a={op:b.POW,
args:[a,{op:b.NUM,args:["2"]},{op:b.NUM,args:["-1"]}]};break;default:assert(!1,f(1001,["{ or (",String.fromCharCode(m)]))}break;case M:case N:case O:case P:case Q:case R:c();for(a=[];m===B;)c(),a.push(v());a.unshift({op:h[q],args:[e()]});return 1<a.length?{op:b.POW,args:a}:a[0];case S:return c(),{op:b.LOG,args:[{op:b.VAR,args:["e"]},e()]};case T:return c(),{op:b.LOG,args:[{op:b.NUM,args:["10"]},e()]};case U:return c(),a=[],m===C?(c(),a.push(e())):a.push({op:b.VAR,args:["e"]}),a.push(e()),{op:b.LOG,
args:a};case V:return c(),a=[],d(C),a.push(e()),a.push(e()),{op:h[q],args:a};case W:case X:case Y:return c(),a=[],m===C&&(c(),a.push(e()),d(B),a.push(e())),a.push(u()),{op:h[q],args:a};case Z:return c(),{op:b.EXISTS,args:[$()]};case aa:return c(),{op:b.FORALL,args:[u()]};case ba:return c(),{op:b.EXP,args:[ca()]};default:assert(!1,"Model.primaryExpr() unexpected expression kind "+s.lexeme()),a=void 0}return a}function n(){d(K);var b=u();d(qa);return b}function v(){var a;switch(m){case da:c();a=v();
break;case D:c();a=v();a={op:b.SUB,args:[a]};break;default:switch(a=e(),m){case ra:c(),a={op:b.PERCENT,args:[a]}}}return a}function la(){for(var a=[v()];m===C;)c(),a.push(v());return 1<a.length?{op:b.SUBSCRIPT,args:a}:a[0]}function ma(){for(var a=[la()];m===B;)c(),a.push(la());return 1<a.length?{op:b.POW,args:a}:a[0]}function na(){for(var a,f,d=[ma()];(a=m)&&!sa(a)&&!ta(a)&&a!==E&&a!==ea&&a!==qa&&a!==J&&a!==z;)a!==F&&a!==G||c(),f=ma(),a===G&&(f={op:b.POW,args:[f,{op:b.NUM,args:["-1"]}]}),d.push(f);
return 1<d.length?{op:b.MUL,args:d}:d[0]}function ua(a){if("number"===typeof a)return-a;if(1===a.args.length){if(a.op===b.SUB)return a.args[0];if(a.op===b.ADD)return a.args[0]=ua(a.args[0]),a}else if(a.op===b.MUL)return a.args.unshift({op:b.NUM,args:["-1"]}),a;return{op:b.MUL,args:[{op:b.NUM,args:["-1"]},a]}}function sa(a){return a===da||a===D||a===H}function ca(){for(var a=na(),f;sa(f=m);){c();var d=na();switch(f){case H:a={op:b.PM,args:[a,d]};break;case D:d=ua(d);default:a={op:b.ADD,args:[a,d]}}}return a}
function ta(a){return a===fa||a===ga||a===ha||a===ia||a===ja||a===ka}function va(){for(var a=ca(),b;ta(b=m);){c();var d=ca();switch(b){default:a={op:h[b],args:[a,d]}}}return a}function $(){for(var a=va(),b;(b=m)===ea;){c();var d=va(),a={op:h[b],args:[a,d]}}return a}function u(){for(var a=$(),b=[a];m===E;)c(),b.push($());return 1<b.length?{op:h[E],args:b}:a}var x=0,da=43,B=94,C=95,N=261,Q=264,R=265,G=47,ea=61,A=256,S=263,K=123,y=91,wa=40,F=42,pa=48,H=258,qa=125,z=93,J=41,P=262,M=259,L=257,D=45,O=260,
t=97,E=44,T=267,U=268,fa=270,ga=271,ha=272,ia=273,Z=274,ja=275,aa=276,V=277,ba=278,ka=279,W=280,X=281,Y=282,ra=37,h=[],m=x,oa=x;h[A]="frac";h[L]="sqrt";h[da]="+";h[D]="-";h[H]="pm";h[B]="^";h[F]="times";h[G]="frac";h[M]="sin";h[N]="cos";h[O]="tan";h[P]="sec";h[Q]="cot";h[R]="csc";h[S]="ln";h[T]="lg";h[U]="log";h[ea]="=";h[E]=",";h[269]="text";h[fa]="lt";h[ga]="le";h[ha]="gt";h[ia]="ge";h[Z]="exists";h[ja]="in";h[aa]="forall";h[V]="lim";h[ba]="exp";h[ka]="to";h[W]="sum";h[X]="int";h[Y]="prod";var s=
function(a){function b(e){var f=String.fromCharCode(e);for(d+=f;97<=e&&122>=e;){e=a.charCodeAt(c++);var f=String.fromCharCode(e),k=d+f;if(!some(h,function(a){return 0===a.indexOf(k)}))break;d+=f}c--;return t}var c=0,d="",e=[];e["\\cdot"]=F;e["\\times"]=F;e["\\div"]=G;e["\\dfrac"]=A;e["\\frac"]=A;e["\\sqrt"]=L;e["\\pm"]=H;e["\\sin"]=M;e["\\cos"]=N;e["\\tan"]=O;e["\\sec"]=P;e["\\cot"]=Q;e["\\csc"]=R;e["\\ln"]=S;e["\\lg"]=T;e["\\log"]=U;e["\\left"]=null;e["\\right"]=null;e["\\big"]=null;e["\\Big"]=null;
e["\\bigg"]=null;e["\\Bigg"]=null;e["\\text"]=269;e["\\textrm"]=269;e["\\textit"]=269;e["\\textbf"]=269;e["\\lt"]=fa;e["\\le"]=ga;e["\\gt"]=ha;e["\\ge"]=ia;e["\\exists"]=Z;e["\\in"]=ja;e["\\forall"]=aa;e["\\lim"]=V;e["\\exp"]=ba;e["\\to"]=ka;e["\\sum"]=W;e["\\int"]=X;e["\\prod"]=Y;e["\\%"]=ra;var h="g cg kg mg ng m cm km mm nm L mL s cs ks ms ns in ft mi fl cup pt qt gal oz lb".split(" ");return{start:function(){var g;for(d="";c<a.length;)switch(g=a.charCodeAt(c++)){case 32:case 9:case 10:case 13:continue;
case 92:d+=String.fromCharCode(g);g=a.charCodeAt(c++);if(36===g)d=String.fromCharCode(g);else if(37===g)d+=String.fromCharCode(g);else{for(;97<=g&&122>=g||65<=g&&90>=g;)d+=String.fromCharCode(g),g=a.charCodeAt(c++);c--}g=e[d];if(void 0===g)g=t;else if(269===g){for(g=a.charCodeAt(c++);123!==g;)g=a.charCodeAt(c++);d="";for(g=a.charCodeAt(c++);125!==g;)g=String.fromCharCode(g),d+=g,g=a.charCodeAt(c++);g=t}if(g)return g;d="";continue;case 37:case 40:case 41:case 42:case 43:case 44:case 45:case 47:case 61:case 91:case 93:case 94:case 95:case 123:case 125:return d+=
String.fromCharCode(g),g;case 36:return d+=String.fromCharCode(g),t;default:if(65<=g&&90>=g)return d+=String.fromCharCode(g),t;if(97<=g&&122>=g)return b(g);if(46===g||48<=g&&57>=g){for(;48<=g&&57>=g||46===g;)d+=String.fromCharCode(g),g=a.charCodeAt(c++);c--;return pa}assert(!1,f(1004,[String.fromCharCode(g),g]));return 0}return 0},lexeme:function(){return d},pos:function(){return c}}}(a);return{expr:function(){m=s.start();var a=u();assert(!m,f(1003,[s.pos(),s.lexeme()]));return a}}};return b}();
