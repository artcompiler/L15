...
if(void 0===b)return this.args[a];this.args[a]=b;return this};a.prototype.args=function(a){if(!d(this))throw"Malformed node";if(void 0===a)return this.args;this.args=a;return this};a.prototype.isNode=d;a.intern=a.prototype.intern=function b(f){this instanceof a&&void 0===f&&d(this)&&(f=this);assert("object"===typeof f,"node not an object");for(var C=f.op,t=f.args.length,V="",H=[],w=0;w<t;w++)V="string"===typeof f.args[w]?V+(H[w]=f.args[w]):V+(H[w]=b(f.args[w]));f=C+t+V;t=p[f];void 0===t&&(e.push({op:C,
...
f[b.POW]="^";f[b.SUBSCRIPT]="_";f[b.PM]="\\pm";f[b.SIN]="\\sin";f[b.COS]="\\cos";f[b.TAN]="\\tan";f[b.ARCSIN]="\\arcsin";f[b.ARCCOS]="\\arccos";f[b.ARCTAN]="\\arctan";f[b.SEC]="\\sec";f[b.COT]="\\cot";f[b.CSC]="\\csc";f[b.LN]="\\ln";f[b.COMMA]=",";f[b.M]="\\M";f[b.BINOM]="\\binom";f[b.COLON]="\\colon";a.fold=function w(a,d){var g=[],f;forEach(a.args,function(a){g.push(w(a,d))});a.args=g;switch(a.op){case b.VAR:if(f=d[a.args[0]])a=f}return a};var C=function cb(a){var d="";if("string"===typeof a)d=
a;else if("number"===typeof a)d=a;else if("object"===typeof a){for(var e=[],m=0;m<a.args.length;m++)e[m]=cb(a.args[m]);switch(a.op){case b.VAR:case b.CST:case b.NUM:d=a.args[0];break;case b.SUB:d=1===a.args.length?f[a.op]+" "+e[0]:e[0]+" "+f[a.op]+" "+e[1];break;case b.DIV:case b.PM:case b.EQL:d=e[0]+" "+f[a.op]+" "+e[1];break;case b.POW:var m=a.args[0],p=a.args[1];if(m.args&&2===m.args.length||p.args&&2===p.args.length)if(m.op===b.ADD||m.op===b.SUB||m.op===b.MUL||m.op===b.DIV||m.op===b.SQRT)e[0]=
...
k=c.toString(),f="",l,g,n,h=!1,W="integer",r,s;"."===c&&assert(!1,m(1004,[c,c.charCodeAt(0)]));for(c=0;c<k.length;c++)p(l=k.charAt(c))?(h&&g!==c-4&&assert(!1,m(1005)),g=c,h=!0):(l===q()?(l=".","decimal"===W&&assert(!1,m(1007,[q(),f+q()])),W="decimal",h&&g!==c-4&&assert(!1,m(1005)),h=!1,"0"===f&&(r=!0),n=c-1):"decimal"===W&&"0"!==l&&(n=c),f+=l);h&&g!==c-4&&assert(!1,m(1005));void 0!==n&&(n+1<f.length&&(s=!0),e&&(f=f.substring(0,n+1)));f=new BigDecimal(f);b&&(b=option("decimalPlaces"),!d||f.scale()>
b)&&(f=f.setScale(b,BigDecimal.ROUND_HALF_UP));return{op:a.NUM,args:[String(f)],hasThousandsSeparator:h,numberFormat:W,hasLeadingZero:r,hasTrailingZero:s}}function L(c,b){return u(a.MUL,c,b)}function x(c,b){assert(1===b.length,"Wrong number of arguments for unary node");return c===a.ADD?b[0]:g(c,b)}function u(a,b,d){assert(1<b.length,"Too few argument for binary node");var e=[];forEach(b,function(b){d&&b.op===a?e=e.concat(b.args):e.push(b)});return g(a,e)}function n(a){h=Ta;Ta=X;h===X&&(h=y.start(a))}
function r(a,b){var d=h;if(d!==a){var e=String.fromCharCode(a),d=d?String.fromCharCode(d):"EOS";assert(!1,m(1001,[e,d]))}n(b)}function v(){var c,b;switch(b=h){case 65:case 97:case I:c=[y.lexeme()];n();(f=h)===D&&(n({oneCharToken:!0}),c.push(v()));c=g(a.VAR,c);d()&&((f=h)===E||f===z?(n(),c=x(l[f],[c])):h===F&&(r(F),r(Y)));break;case ja:c=t(y.lexeme());n();!d()||(f=h)!==E&&f!==z||(n(),c=x(l[f],[c]));break;case Z:case $:var e;r(b);c=J();a.option("allowInterval")?r(e=h===M?M:N):r(e=b===Z?M:N);c.lbrk=
b;c.rbrk=e;!a.option("allowInterval")||2!==c.args.length||b!==Z&&b!==$||e!==M&&e!==N?c.op===a.COMMA&&(c.op=a.LIST):c.op=a.INTERVAL;break;case F:c=s();break;case Ua:n();b=s();e=[];for(e.push(C());h===O;)n(),e.push(C());e=g(l[O],e);r(ka);s();0<=b.args[0].indexOf("matrix")?c=g(a.MATRIX,[e]):assert(!1,"Unrecognized LaTeX name");break;case A:r(A);b=aa();r(A);c=x(a.ABS,[b]);break;case ba:n();c=s();e=s();c=g(a.FRAC,[c,e]);c.isFraction=!0;break;case la:n();c=s();e=s();b=x(a.FACT,[c]);c=u(a.POW,[u(a.MUL,[x(a.FACT,
[e]),x(a.FACT,[u(a.ADD,[c,ma(e)])])]),B]);c=u(a.MUL,[b,c]);c.isBinomial=!0;break;case na:n();switch(h){case $:r($);b=J();r(N);c=s();c=g(a.POW,[c,g(a.POW,[b,B])]);break;case F:c=s();c=g(a.POW,[c,g(a.POW,[g(a.NUM,["2"]),B])]);break;default:assert(!1,m(1001,["{ or (",String.fromCharCode(h)]))}break;case oa:n();b=s();c=g(a.VEC,[b]);break;case pa:case qa:case ra:n();var f;for(c=[];h===K;)n({oneCharToken:!0}),c.push(G());1===c.length&&c[0].op===a.NUM&&"-1"===c[0].args[0]?(b="arc"+l[b],c=[]):b=l[b];c.unshift(g(b,
[v()]));return 1<c.length?g(a.POW,c):c[0];case sa:case ta:case ua:case va:case wa:case xa:n();for(c=[];h===K;)n({oneCharToken:!0}),c.push(G());c.unshift(g(l[b],[v()]));return 1<c.length?g(a.POW,c):c[0];case ya:return n(),g(a.LOG,[g(a.VAR,["e"]),v()]);case za:return n(),g(a.LOG,[g(a.NUM,["10"]),v()]);case Aa:return n(),c=[],h===D?(n({oneCharToken:!0}),c.push(v())):c.push(g(a.VAR,["e"])),c.push(v()),g(a.LOG,c);case Ba:return n(),c=[],r(D),c.push(v()),c.push(v()),g(l[b],c);case Ca:case Da:case Ea:return n(),
c=[],h===D&&(n({oneCharToken:!0}),c.push(v()),r(K,{oneCharToken:!0}),c.push(v())),c.push(J()),g(l[b],c);case Fa:return n(),g(a.EXISTS,[P()]);case Ga:return n(),g(a.FORALL,[J()]);case Ha:return n(),g(a.EXP,[aa()]);case Va:return n(),g(a.M,[Ia()]);case Ja:return n(),g(a.FORMAT,[s()]);case Ka:return n(),g(a.OVERLINE,[s()]);case La:case Ma:return n(),c=s(),e=s(),e.args.push(g(l[b],[c])),e;default:assert(!1,m(1006,[y.lexeme()])),c=void 0}return c}function C(){var a=[];for(a.push(P());h===Q;)n(),a.push(P());
return g(l[Q],a)}function s(){r(F);var a=J();r(Y);return a}function ca(){var c;var b;for(c=[v()];(b=h)===K;){n({oneCharToken:!0});var e;e=c[0];e=e.op!==a.VAR?!1:(e=a.env[e.args[0]])&&e.name?!0:!1;!(e||d()&&c[0].op===a.VAR)||(b=h)!==E&&b!==z?(b=G(),b.op===a.VAR&&"\\circ"===b.args[0]?c=[L([c[0],g(a.VAR,["\\degree"])])]:c.push(b)):(n(),c.push(x(l[b],[Wa])))}c=1<c.length?g(a.POW,c):c[0];switch(h){case Xa:n();c=g(a.PERCENT,[c]);break;case Ya:n(),c=g(a.FACT,[c])}return c}function G(){var c,b;switch(c=h){case E:n();
b=ca();break;case z:n();b=ma(ca());break;case R:n();b=G();b=g(l[c],[b]);break;case D:case K:var d=l[c];n({oneCharToken:!0});(c=h)===E||c===z?(n(),b=Wa):b=G();b=g(d,[b]);break;default:c===I&&"$"===y.lexeme()?(n(),b=h?L([g(a.VAR,["$"]),ca()]):g(a.VAR,["$"])):b=ca()}return b}function Za(){var c=[G()];h===D&&(n({oneCharToken:!0}),c.push(G()),d()&&h===F&&(r(F),r(Y)));return 1<c.length?g(a.SUBSCRIPT,c):c[0]}function $a(){for(var c=Za();h===Na;)n(),c=g(a.FRAC,[c,Za()]),c.isFraction=!0;return c}function Ia(){var c,
b,e=!1,f=[];b=$a();for(f=b.op!==a.MUL||b.isBinomial?[b]:b.args;(c=h)&&!ab(c)&&!Oa(c)&&c!==da&&c!==ea&&c!==Y&&c!==M&&c!==N&&c!==S&&c!==T&&c!==A&&c!==O&&c!==Q&&c!==ka;){e=!1;if(c===U||c===fa||c===Na)n(),e=!0;b=$a();c===fa&&(b=g(a.POW,[b,B]));var k;if(k=d())if(k=c===Z)k=f[f.length-1],assert(!0,"Internal error in 'isVar()'"),k=k.op!==a.VAR?!1:void 0===k?!0:"M"===k.args[0];if(k)f.pop(),b=x(a.M,[b]);else{if(k=!e)if(k=0<f.length)k=[f[f.length-1],b],k=k[0].lbrk||k[1].lbrk||k[0].op!==a.NUM||k[1].op!==a.FRAC||
"integer"!==k[0].numberFormat||k[1].args[0].op!==a.NUM||"integer"!==k[1].args[0].numberFormat||k[1].args[1].op!==a.NUM||"integer"!==k[1].args[1].numberFormat?!1:!0;if(k)c=f.pop(),Pa(c)&&(b=u(a.MUL,[B,b])),b=u(a.ADD,[c,b]),b.isMixedFraction=!0;else{if(k=!e)if(k=0<f.length)k=[f[f.length-1],b],k=k[0].lbrk||k[1].lbrk||k[0].op!==a.NUM||"decimal"!==k[0].numberFormat||k[1].op!==a.OVERLINE?!1:!0;if(k)c=f.pop(),c.args[0]=c.args[0]+"."+b.args[0].args[0],c.isRepeatingFraction=!0,b=c;else{if(k=c===U)if(k=0<f.length)e&&
(k=[f[f.length-1],b],1===k.length?e=k[0].op===a.NUM&&(1===k[0].args[0].length||1===k[0].args[0].indexOf(q()))||k[0].op===a.POW&&k[0].args[0].op===a.NUM&&"10"===k[0].args[0].args[0]&&"integer"===k[0].args[1].numberFormat?!0:!1:2===k.length?(e=k[0],k=k[1],e=e.op!==a.NUM||1!==e.args[0].length&&1!==e.args[0].indexOf(q())||k.op!==a.POW||k.args[0].op!==a.NUM||"10"!==k.args[0].args[0]||"integer"!==k.args[1].numberFormat?!1:!0):e=void 0),k=e;k&&(c=f.pop(),Pa(c)&&(b=u(a.MUL,[B,b])),b=u(a.MUL,[c,b]),b.isScientific=
...
function ma(b){return"number"===typeof b?-b:b.op===a.NUM?"-"===b.args[0].charAt(0)?x(a.SUB,[b]):t("-"+b.args[0]):b.op===a.MUL?(b.args.unshift(B),b):L([B,b])}function ab(a){return a===E||a===z||a===R}function aa(){for(var b=Ia(),d;ab(d=h);){n();var e=Ia();switch(d){case R:b=u(a.PM,[b,e]);break;case z:e=ma(e);default:b=u(a.ADD,[b,e],!0)}}return b}function Oa(a){return a===T||a===ga||a===ha||a===ia||a===Qa||a===Ra||a===Sa}function bb(){for(var b=h,d=Oa(b)?g(a.VAR,["_"]):aa(),e=[];Oa(b=h);){n();var f=
0===h?g(a.VAR,["_"]):aa(),d=g(l[b],[d,f]);e.push(d);d=f}return 0===e.length?d:1===e.length?e[0]:g(a.COMMA,e)}function P(){for(var b=h===ea?g(a.VAR,["_"]):bb(),d;(d=h)===ea||d===S;){n();var e=0===h?g(a.VAR,["_"]):bb(),b=g(l[d],[b,e])}return b}function J(){for(var a=P(),b=[a];h===da;)n(),b.push(P());return 1<b.length?g(l[da],b):a}var X=0,E=43,K=94,D=95,qa=261,wa=264,xa=265,ba=256,Na=47,ea=61,ya=263,F=123,A=124,$=91,Z=40,U=42,ja=48,R=258,Y=125,N=93,M=41,va=262,pa=259,na=257,z=45,ra=260,I=97,da=44,za=
267,Aa=268,T=270,ga=271,ha=272,ia=273,Fa=274,Qa=275,Ga=276,Ba=277,Ha=278,Ra=279,Ca=280,Da=281,Ea=282,Xa=37,Va=283,S=284,Ya=33,la=285,O=286,Q=287,Ua=288,ka=289,Sa=58,oa=290,sa=291,ta=292,ua=293,fa=294,Ja=295,Ka=296,La=297,Ma=298,h=X,Ta=X,l={};l[Na]=b.FRAC;l[ba]=b.FRAC;l[na]=b.SQRT;l[oa]=b.VEC;l[E]=b.ADD;l[z]=b.SUB;l[R]=b.PM;l[K]=b.POW;l[D]=b.SUBSCRIPT;l[U]=b.MUL;l[fa]=b.DIV;l[pa]=b.SIN;l[qa]=b.COS;l[ra]=b.TAN;l[sa]=b.ARCSIN;l[ta]=b.ARCCOS;l[ua]=b.ARCTAN;l[va]=b.SEC;l[wa]=b.COT;l[xa]=b.CSC;l[ya]=b.LN;
l[za]=b.LG;l[Aa]=b.LOG;l[ea]=b.EQL;l[da]=b.COMMA;l[269]=b.TEXT;l[T]=b.LT;l[ga]=b.LE;l[ha]=b.GT;l[ia]=b.GE;l[Fa]=b.EXISTS;l[Qa]=b.IN;l[Ga]=b.FORALL;l[Ba]=b.LIM;l[Ha]=b.EXP;l[Ra]=b.TO;l[Ca]=b.SUM;l[Da]=b.INT;l[Ea]=b.PROD;l[Va]=b.M;l[S]=b.RIGHTARROW;l[Ya]=b.FACT;l[la]=b.BINOM;l[O]=b.ROW;l[Q]=b.COL;l[Sa]=b.COLON;l[Ja]=b.FORMAT;l[Ka]=b.OVERLINE;l[La]=b.OVERSET;l[Ma]=b.UNDERSET;var Wa=t("1"),B=t("-1"),y=function(b){function d(a){return 65<=a&&90>=a||97<=a&&122>=a}function e(a){return 48<=a&&57>=a}function l(a){var e=
String.fromCharCode(a);for(g+=e;d(a)||39===a;){a=b.charCodeAt(k++);var e=String.fromCharCode(a),f=g+e;if(!some(h,function(a){return 0===a.indexOf(f)}))break;g+=e}for(;39===a;)a=b.charCodeAt(k++),e=String.fromCharCode(a),g+=e;k--;return I}var k=0,g="",n={"\\cdot":U,"\\times":U,"\\div":fa,"\\dfrac":ba,"\\frac":ba,"\\sqrt":na,"\\vec":oa,"\\pm":R,"\\sin":pa,"\\cos":qa,"\\tan":ra,"\\sec":va,"\\cot":wa,"\\csc":xa,"\\arcsin":sa,"\\arccos":ta,"\\arctan":ua,"\\ln":ya,"\\lg":za,"\\log":Aa,"\\left":null,"\\right":null,
...
(f={});var h;for(g="";k<b.length;)switch(h=b.charCodeAt(k++)){case 32:case 9:case 10:case 13:continue;case 38:if(0===b.substring(k).indexOf("nbsp;")){k+=5;continue}return Q;case 92:g+=String.fromCharCode(h);if(92===b.charCodeAt(k))return k++,O;h=b.charCodeAt(k++);if(36===h)g=String.fromCharCode(h);else if(37===h)g+=String.fromCharCode(h);else if(0<=[32,58,59,44,33].indexOf(h))g="\\ ";else{for(;d(h);)g+=String.fromCharCode(h),h=b.charCodeAt(k++);k--}h=n[g];if(void 0===h)h=I;else if(269===h){for(h=
b.charCodeAt(k++);123!==h;)h=b.charCodeAt(k++);g="";for(h=b.charCodeAt(k++);125!==h;)h=String.fromCharCode(h),"&"===h&&0===b.substring(k).indexOf("nbsp;")?k+=5:" "!==h&&"\t"!==h&&(g+=h),h=b.charCodeAt(k++);h=a.option("ignoreText")?null:I}if(null!==h)return h;g="";continue;case 45:if(62===b.charCodeAt(k))return k++,S;case 33:case 37:case 40:case 41:case 42:case 43:case 44:case 47:case 58:case 61:case 91:case 93:case 94:case 95:case 123:case 124:case 125:return g+=String.fromCharCode(h),h;case 36:return g+=
String.fromCharCode(h),I;case 60:return 61===b.charCodeAt(k)?(k++,ga):T;case 62:return 61===b.charCodeAt(k)?(k++,ia):ha;default:if(d(h)||39===h)return l(h);if(String.fromCharCode(h)===q()||e(h)){if(f.oneCharToken)return g+=String.fromCharCode(h),ja;for(f=h;e(f)||q()===String.fromCharCode(f)||(r=p(String.fromCharCode(f),r))&&e(b.charCodeAt(k+1));)g+=String.fromCharCode(f),f=b.charCodeAt(k++),92===f&&32===b.charCodeAt(k)&&(f=32,k++);k--;return ja}assert(!1,m(1004,[String.fromCharCode(h),h]));return 0}return 0},
lexeme:function(){return g},pos:function(){return k}}}(e);return{expr:function(){if(h=y.start(void 0)){var a=J();assert(!h,m(1003,[y.pos(),y.lexeme()]));return a}return t("dummy")}}};return a}();
