...
function(b){g.push(A(b,d))});b.args=g;switch(b.op){case a.VAR:if(m=d[b.args[0]])b=m}return b};var G=function jb(b){var d="";if("string"===typeof b)d=b;else if("number"===typeof b)d=b;else if("object"===typeof b){for(var l=[],e=0;e<b.args.length;e++)l[e]=jb(b.args[e]);switch(b.op){case a.VAR:case a.CST:case a.NUM:d=b.args[0];break;case a.SUB:d=1===b.args.length?m[b.op]+" "+l[0]:l[0]+" "+m[b.op]+" "+l[1];break;case a.DIV:case a.PM:case a.EQL:d=l[0]+" "+m[b.op]+" "+l[1];break;case a.POW:var e=b.args[0],
...
"unimplemented eval operator")}}else assert(!1,"invalid expression type");return d},s=function(m,e){function g(b,a){return{op:b,args:a}}function p(c,a){if(b.option("allowThousandsSeparator")||b.option("setThousandsSeparator")){var d=b.option("setThousandsSeparator");if(!d)return","===c?c:"";if(c===a||!a&&0<=d.indexOf(c))return c}return""}function q(){var c=b.option("setDecimalSeparator"),a=b.option("setThousandsSeparator");if("string"===typeof c)return assert(1===c.length,l(1002)),a instanceof Array&&
0<=a.indexOf(c)?(assert(!1,l(2008,[c])),"."):c;a instanceof Array&&0<=a.indexOf(".")&&assert(!1,l(2008));return"."}function s(c,a,d){var m=b.option("ignoreTrailingZeros"),h=c.toString(),f="",e,g,n,k=0,S="integer",r,t;"."===c&&assert(!1,l(1004,[c,c.charCodeAt(0)]));for(c=0;c<h.length;c++)p(e=h.charAt(c))?((k&&g!==c-4||!k&&4<c)&&assert(!1,l(1005)),g=c,k++):(e===q()?(e=".","decimal"===S&&assert(!1,l(1007,[q(),f+q()])),S="decimal",k&&g!==c-4&&assert(!1,l(1005)),"0"===f&&(r=!0),n=c-1):"decimal"===S&&"0"!==
e&&(n=c-k),f+=e);"decimal"!==S&&g&&g!==c-4&&assert(!1,l(1005));void 0!==n&&(n+1<f.length&&(t=!0),m&&(f=f.substring(0,n+1)));f=new BigDecimal(f);a&&(a=option("decimalPlaces"),!d||f.scale()>a)&&(f=f.setScale(a,BigDecimal.ROUND_HALF_UP));return{op:b.NUM,args:[String(f)],hasThousandsSeparator:0!==k,numberFormat:S,hasLeadingZero:r,hasTrailingZero:t}}function H(c,a){return u(b.MUL,c,a)}function v(b,a){assert(1===a.length,"Wrong number of arguments for unary node");return g(b,a)}function u(b,a,d){assert(1<
a.length,"Too few argument for binary node");var f=[];forEach(a,function(a){d&&a.op===b?f=f.concat(a.args):f.push(a)});return g(b,f)}function w(){return N.lexeme()}function n(b){k=T;T=U;k===U&&(k=N.start(b))}function G(b){T===U&&(T=N.start(b));return T}function r(b,a){var d=k;if(d!==b){var f=String.fromCharCode(b),d=d?String.fromCharCode(d):"EOS";assert(!1,l(1001,[f,d]))}n(a)}function x(){var c,a;switch(a=k){case 65:case 97:case B:c=[w()];n();k===I&&(n({oneCharToken:!0}),c.push(x()));c=g(b.VAR,c);
d()&&k===C&&G()===z&&(r(C),r(z));break;case na:c=s(w());n();break;case ca:case V:var e;r(a);k===J||k===K?(r(a===V?J:K),c=g(b.COMMA,[])):(c=O(),b.option("allowInterval")?r(e=k===J?J:K):r(e=a===V?J:K));c.lbrk=a;c.rbrk=e;!b.option("allowInterval")||2!==c.args.length||a!==V&&a!==ca||e!==J&&e!==K?c.op===b.COMMA&&(c.op=b.LIST):c.op=b.INTERVAL;break;case C:c=t();break;case Za:n();a=t();e=[];for(e.push($a());k===W;)n(),e.push($a());e=g(f[W],e);r(oa);t();0<=a.args[0].indexOf("matrix")?c=g(b.MATRIX,[e]):assert(!1,
"Unrecognized LaTeX name");break;case E:r(E);a=P();r(E);c=v(b.ABS,[a]);break;case ab:return n(),c=P(),v(b.ABS,[c]);case da:n();c=t();e=t();c=g(b.FRAC,[c,e]);c.isFraction=!0;break;case pa:n();c=t();e=t();a=v(b.FACT,[c]);c=u(b.POW,[u(b.MUL,[v(b.FACT,[e]),v(b.FACT,[u(b.ADD,[c,ea(e)])])]),Q]);c=u(b.MUL,[a,c]);c.isBinomial=!0;break;case qa:n();switch(k){case ca:r(ca);a=O();r(K);c=t();c=g(b.POW,[c,g(b.POW,[a,Q])]);break;case C:c=t();c=g(b.POW,[c,g(b.POW,[g(b.NUM,["2"]),Q])]);break;default:assert(!1,l(1001,
["{ or (",String.fromCharCode(k)]))}break;case ra:n();a=t();c=g(b.VEC,[a]);break;case sa:case ta:case ua:n();for(c=[];k===L;)n({oneCharToken:!0}),c.push(y());1===c.length&&c[0].op===b.NUM&&"-1"===c[0].args[0]?(a="arc"+f[a],c=[]):a=f[a];c.unshift(g(a,[x()]));return 1<c.length?g(b.POW,c):c[0];case va:case wa:case xa:case ya:case za:case Aa:n();for(c=[];k===L;)n({oneCharToken:!0}),c.push(y());c.unshift(g(f[a],[x()]));return 1<c.length?g(b.POW,c):c[0];case Ba:return n(),g(b.LOG,[g(b.VAR,["e"]),x()]);
case Ca:return n(),g(b.LOG,[g(b.NUM,["10"]),x()]);case Da:return n(),c=[],k===I?(n({oneCharToken:!0}),c.push(x())):c.push(g(b.VAR,["e"])),c.push(x()),g(b.LOG,c);case Ea:return n(),c=[],r(I),c.push(x()),c.push(x()),g(f[a],c);case Fa:case Ga:case Ha:return n(),c=[],k===I&&(n({oneCharToken:!0}),c.push(x()),r(L,{oneCharToken:!0}),c.push(x())),c.push(O()),g(f[a],c);case Ia:return n(),g(b.EXISTS,[X()]);case Ja:return n(),g(b.FORALL,[O()]);case Ka:return n(),g(b.EXP,[P()]);case bb:return n(),g(b.M,[La()]);
case Ma:return n(),g(b.FORMAT,[t()]);case Na:return n(),g(b.OVERLINE,[t()]);case Oa:case Pa:return n(),c=t(),e=t(),e.args.push(g(f[a],[c])),e;case Qa:n();c=t();break;default:assert(!1,l(1006,[w()])),c=void 0}return c}function $a(){var b=[];for(b.push(X());k===Y;)n(),b.push(X());return g(f[Y],b)}function t(){var c;r(C);k===z?(r(z),c=g(b.COMMA,[])):(c=O(),r(z));c.lbrk=C;c.rbrk=z;return c}function cb(){var c,a;for(c=[x()];(a=k)===L;){n({oneCharToken:!0});var e;e=c[0];e=e.op!==b.VAR?!1:(e=b.env[e.args[0]])&&
e.name?!0:!1;!e&&!d()||(a=k)!==F&&a!==D?(a=y(),a.op===b.VAR&&"\\circ"===a.args[0]&&(k===B&&"K"===w()||"C"===w()||"F"===w()?(a=H([c.pop(),v(b.VAR,["\\degree "+w()])]),n()):a=H([c.pop(),v(b.VAR,["\\degree"])])),c.push(a)):(n(),c.push(v(f[a],[fa])))}a=1<c.length?g(b.POW,c):c[0];switch(c=k){case db:n();a=g(b.PERCENT,[a]);break;case eb:n();a=g(b.FACT,[a]);break;default:c===B&&"\\degree"===w()?(n(),k!==B||"K"!==w()&&"C"!==w()&&"F"!==w()?a=H([a,v(b.VAR,["\\degree"])]):(a=H([a,v(b.VAR,["\\degree "+w()])]),
n())):!d()||c!==F&&c!==D||G()!==z||(n(),a=v(f[c],[a]))}return a}function y(){var c,a;switch(c=k){case F:n();a=y();break;case D:n();a=ea(y());break;case Z:n();a=y();a=g(f[c],[a]);break;case I:var d=f[c];n({oneCharToken:!0});(c=k)===F||c===D?(n(),a=fa):a=y();a=g(d,[a]);k===L&&(d=f[c],n({oneCharToken:!0}),(c=k)===F||c===D?(n(),a=fa):a=y(),a=g(d,[a]));break;case L:d=f[c];n({oneCharToken:!0});(c=k)===F||c===D?(n(),a=fa):a=y();a=g(d,[a]);break;default:c===B&&"$"===w()?(n(),a=k?H([g(b.VAR,["$"]),cb()]):
g(b.VAR,["$"])):a=cb()}return a}function fb(){var c=[y()];k===I&&(n({oneCharToken:!0}),c.push(y()),d()&&k===C&&(r(C),r(z)));return 1<c.length?g(b.SUBSCRIPT,c):c[0]}function gb(){for(var c=fb();k===Ra;)n(),c=g(b.FRAC,[c,fb()]),c.isFraction=!0;return c}function La(){var c,a,e=!1,f=[];a=gb();for(f=a.op!==b.MUL||a.isBinomial?[a]:a.args;(c=k)&&!hb(c)&&!Sa(c)&&c!==ga&&!Ta(c)&&c!==z&&c!==J&&c!==K&&c!==R&&c!==$&&c!==E&&c!==W&&c!==Y&&c!==oa;){e=!1;if(c===aa||c===ha||c===Ra)n(),e=!0;a=gb();c===ha&&(a=g(b.POW,
[a,Q]));var h;if(h=d())if(h=c===V)h=f[f.length-1],assert(!0,"Internal error in 'isVar()'"),h=h.op!==b.VAR?!1:void 0===h?!0:"M"===h.args[0];if(h)f.pop(),a=v(b.M,[a]);else{if(h=!e)if(h=0<f.length)h=[f[f.length-1],a],h=h[0].lbrk||h[1].lbrk||h[0].op!==b.NUM||h[1].op!==b.FRAC||"integer"!==h[0].numberFormat||h[1].args[0].op!==b.NUM||"integer"!==h[1].args[0].numberFormat||h[1].args[1].op!==b.NUM||"integer"!==h[1].args[1].numberFormat?!1:!0;if(h)c=f.pop(),Ua(c)&&(a=u(b.MUL,[Q,a])),a=u(b.ADD,[c,a]),a.isMixedFraction=
!0;else{if(h=!e)if(h=0<f.length)h=[f[f.length-1],a],h=h[0].lbrk||h[1].lbrk||h[0].op!==b.NUM||"decimal"!==h[0].numberFormat||h[1].op!==b.OVERLINE?!1:!0;if(h)e=f.pop(),a=a.args[0],a=s("."+a.args[0]),a.isRepeating=!0,0<=e.args[0].indexOf(".")&&(h=e.args[0].length-e.args[0].indexOf(".")-1,a=H([a,u(b.POW,[s("10"),s("-"+h)])])),a=u(b.ADD,[e,a]),a.numberFormat="decimal",a.isRepeating=!0;else{if(h=c===aa)if(h=0<f.length)e&&(h=[f[f.length-1],a],1===h.length?e=h[0].op===b.NUM&&(1===h[0].args[0].length||1===
h[0].args[0].indexOf(q()))||h[0].op===b.POW&&h[0].args[0].op===b.NUM&&"10"===h[0].args[0].args[0]&&"integer"===h[0].args[1].numberFormat?!0:!1:2===h.length?(e=h[0],h=h[1],e=e.op!==b.NUM||1!==e.args[0].length&&1!==e.args[0].indexOf(q())||h.op!==b.POW||h.args[0].op!==b.NUM||"10"!==h.args[0].args[0]||"integer"!==h.args[1].numberFormat?!1:!0):e=void 0),h=e;h&&(c=f.pop(),Ua(c)&&(a=u(b.MUL,[Q,a])),a=u(b.MUL,[c,a]),a.isScientific=!0)}}}a.op!==b.MUL||a.isScientific||a.isBinomial?f.push(a):f=f.concat(a.args)}return 1<
f.length?H(f):f[0]}function Ua(c){if("number"===typeof c)return 0>c;if(1===c.args.length)return c.op===a.SUB&&0<c.args[0].args[0]||c.op===b.NUM&&0>+c.args[0];if(2===c.args.length)return c.op===a.MUL&&Ua(c.args[0])}function ea(a){if("number"===typeof a)return-a;if(a.op===b.NUM){if("-"!==a.args[0].charAt(0))return s("-"+a.args[0])}else if(a.op===b.MUL)return a.args.unshift(ea(a.args.shift())),a;return v(b.SUB,[a])}function hb(b){return b===F||b===D||b===Z||b===ia}function P(){for(var a=La(),d;hb(d=
k);){n();var e=La();switch(d){case ia:a=u(b.BACKSLASH,[a,e]);break;case Z:a=u(b.PM,[a,e]);break;case D:e=ea(e);default:a=u(b.ADD,[a,e],!0)}}return a}function Sa(b){return b===$||b===ja||b===ka||b===la||b===Va||b===Wa||b===Xa}function Ta(b){return b===ib||b===ma||b===Ya}function X(){var a;if(Ta(k))a=g(b.VAR,["_"]);else{a=k;for(var d=Sa(a)?g(b.VAR,["_"]):P(),e=[];Sa(a=k);){n();var l=0===k?g(b.VAR,["_"]):P(),d=g(f[a],[d,l]);e.push(d);d=l}a=0===e.length?d:1===e.length?e[0]:g(b.COMMA,e)}for(var h,d=[];Ta(h=
k)||h===R;)n(),e=0===k?g(b.VAR,["_"]):P(),a=g(f[h],[a,e]),d.push(a),a=e;return 0===d.length?a:1===d.length?d[0]:g(b.COMMA,d)}function O(){for(var b=X(),a=[b];k===ga;)n(),a.push(X());return 1<a.length?g(f[ga],a):b}var U=0,F=43,L=94,I=95,ta=261,za=264,Aa=265,da=256,Ra=47,ib=61,Ba=263,C=123,E=124,ca=91,V=40,aa=42,na=48,Z=258,z=125,K=93,J=41,ya=262,sa=259,qa=257,D=45,ua=260,B=97,ga=44,Ca=267,Da=268,$=270,ja=271,ka=272,la=273,Ia=274,Va=275,Ja=276,Ea=277,Ka=278,Wa=279,Fa=280,Ga=281,Ha=282,db=37,bb=283,
R=284,eb=33,pa=285,W=286,Y=287,Za=288,oa=289,Xa=58,ra=290,va=291,wa=292,xa=293,ha=294,Ma=295,Na=296,Oa=297,Pa=298,ia=299,Qa=300,ma=301,Ya=302,ab=303,k=U,T=U,f={};f[Ra]=a.FRAC;f[da]=a.FRAC;f[qa]=a.SQRT;f[ra]=a.VEC;f[F]=a.ADD;f[D]=a.SUB;f[Z]=a.PM;f[L]=a.POW;f[I]=a.SUBSCRIPT;f[aa]=a.MUL;f[ha]=a.DIV;f[sa]=a.SIN;f[ta]=a.COS;f[ua]=a.TAN;f[va]=a.ARCSIN;f[wa]=a.ARCCOS;f[xa]=a.ARCTAN;f[ya]=a.SEC;f[za]=a.COT;f[Aa]=a.CSC;f[Ba]=a.LN;f[Ca]=a.LG;f[Da]=a.LOG;f[ib]=a.EQL;f[ga]=a.COMMA;f[269]=a.TEXT;f[$]=a.LT;f[ja]=
a.LE;f[ka]=a.GT;f[la]=a.GE;f[ma]=a.NE;f[Ya]=a.APPROX;f[Ia]=a.EXISTS;f[Va]=a.IN;f[Ja]=a.FORALL;f[Ea]=a.LIM;f[Ka]=a.EXP;f[Wa]=a.TO;f[Fa]=a.SUM;f[Ga]=a.INT;f[Ha]=a.PROD;f[bb]=a.M;f[R]=a.RIGHTARROW;f[eb]=a.FACT;f[pa]=a.BINOM;f[W]=a.ROW;f[Y]=a.COL;f[Xa]=a.COLON;f[Ma]=a.FORMAT;f[Na]=a.OVERLINE;f[Oa]=a.OVERSET;f[Pa]=a.UNDERSET;f[ia]=a.BACKSLASH;f[Qa]=a.MATHBF;var fa=s("1"),Q=s("-1"),kb=g(b.NONE,[s("0")]),N=function(a){function d(a){return 65<=a&&90>=a||97<=a&&122>=a}function f(a){return 48<=a&&57>=a}function m(b){var e=
String.fromCharCode(b);for(g+=e;d(b)||39===b;){b=a.charCodeAt(h++);var e=String.fromCharCode(b),f=g+e;if(!some(k,function(a){return 0===a.indexOf(f)}))break;g+=e}for(;39===b;)b=a.charCodeAt(h++),e=String.fromCharCode(b),g+=e;h--;return B}var h=0,g="",n={"\\cdot":aa,"\\times":aa,"\\div":ha,"\\dfrac":da,"\\frac":da,"\\sqrt":qa,"\\vec":ra,"\\pm":Z,"\\sin":sa,"\\cos":ta,"\\tan":ua,"\\sec":ya,"\\cot":za,"\\csc":Aa,"\\arcsin":va,"\\arccos":wa,"\\arctan":xa,"\\ln":Ba,"\\lg":Ca,"\\log":Da,"\\left":null,"\\right":null,
...
"\\underset":Pa,"\\backslash":ia,"\\mathbf":Qa,"\\abs":ab},k=keys(e),r;return{start:function(e){e||(e={});var k;for(g="";h<a.length;)switch(k=a.charCodeAt(h++)){case 32:case 9:case 10:case 13:continue;case 38:if(0===a.substring(h).indexOf("nbsp;")){h+=5;continue}return Y;case 92:g+=String.fromCharCode(k);switch(a.charCodeAt(h)){case 92:return h++,W;case 123:case 124:case 125:return a.charCodeAt(h++)}k=a.charCodeAt(h++);if(36===k)g=String.fromCharCode(k);else if(37===k)g+=String.fromCharCode(k);else if(0<=
[32,58,59,44,33].indexOf(k))g="\\ ";else{for(;d(k);)g+=String.fromCharCode(k),k=a.charCodeAt(h++);h--}k=n[g];if(void 0===k)k=B;else if(269===k){for(k=a.charCodeAt(h++);k&&123!==k;)k=a.charCodeAt(h++);g="";for(k=a.charCodeAt(h++);k&&125!==k;)k=String.fromCharCode(k),"&"===k&&0===a.substring(h).indexOf("nbsp;")?h+=5:" "!==k&&"\t"!==k&&(g+=k),k=a.charCodeAt(h++);assert(""!==g,l(1009,["\\text"]));k=b.option("ignoreText")?null:B}if(null!==k)return k;g="";continue;case 45:if(62===a.charCodeAt(h))return h++,
R;case 33:return 61===a.charCodeAt(h)?(h++,ma):k;case 37:case 40:case 41:case 42:case 43:case 44:case 47:case 58:case 61:case 91:case 93:case 94:case 95:case 123:case 124:case 125:return g+=String.fromCharCode(k),k;case 36:return g+=String.fromCharCode(k),B;case 60:return 61===a.charCodeAt(h)?(h++,ja):$;case 62:return 61===a.charCodeAt(h)?(h++,la):ka;default:if(d(k)||39===k)return m(k);if(String.fromCharCode(k)===q()||f(k)){if(e.oneCharToken)return g+=String.fromCharCode(k),na;for(e=k;f(e)||q()===
String.fromCharCode(e)||(r=p(String.fromCharCode(e),r))&&f(a.charCodeAt(h+1));)g+=String.fromCharCode(e),e=a.charCodeAt(h++),92===e&&32===a.charCodeAt(h)&&(e=32,h++);"."===g&&0===indexOf(a.substring(h),"overline")&&(g="0.");h--;return na}assert(!1,l(1004,[String.fromCharCode(k),k]));return 0}return 0},lexeme:function(){return g},pos:function(){return h}}}(m);return{expr:function(){if(k=N.start(void 0)){var a=O();a.op!==b.COMMA&&a.lbrk===C&&a.rbrk===z&&(a=g(b.COMMA,[a]));assert(!k,l(1003,[N.pos(),
