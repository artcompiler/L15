...
f.op===a.CST||"number"===typeof n&&"number"!==typeof f||0!==e&&(c+=" "+d[b.op]+" ");c+=k[e];n=f});break;case a.ADD:case a.COMMA:forEach(k,function(a,f){c=0===f?a:c+" "+d[b.op]+" "+a});break;default:assert(!1,"unimplemented eval operator")}}else assert(!1,"invalid expression type");return c},n=function(a){function c(){m=oa;oa=y;m===y&&(m=s.start())}function d(b){var a=m;a!==b&&(b=String.fromCharCode(b),a=a?String.fromCharCode(a):"EOS",assert(!1,f(1001,[b,a])));c()}function e(){var a,q;switch(q=m){case 65:case t:a=
{op:"var",args:[s.lexeme()]};c();break;case 97:a={op:"var",args:[s.lexeme()]};c();break;case pa:a={op:"num",args:[s.lexeme()]};c();break;case va:case z:d(q);a=u();d(tk2=m===I?I:A);2===a.args.length||q!==z&&tk2!==A||assert(!1,f(1002));a.lbrk=q;a.rbrk=tk2;break;case J:a=n();break;case B:c();q=n();a=n();a={op:b.MUL,args:[q,{op:b.POW,args:[a,{op:b.NUM,args:["-1"]}]}]};break;case K:c();switch(m){case z:d(z);q=u();d(A);a=n();a={op:b.POW,args:[a,q,{op:b.NUM,args:["-1"]}]};break;case J:a=n();a=a.op===b.POW?
...
a=void 0}return a}function n(){d(J);var b=u();d(qa);return b}function v(){var a;switch(m){case ca:c();a=v();break;case E:c();a=v();a={op:b.SUB,args:[a]};break;default:a=e()}return a}function la(){for(var a=[v()];m===D;)c(),a.push(v());return 1<a.length?{op:b.SUBSCRIPT,args:a}:a[0]}function ma(){for(var a=[la()];m===C;)c(),a.push(la());return 1<a.length?{op:b.POW,args:a}:a[0]}function na(){for(var a,f,d=[ma()];(a=m)&&!ra(a)&&!sa(a)&&a!==F&&a!==da&&a!==qa&&a!==I&&a!==A;)a!==ea&&a!==G||c(),f=ma(),a===
G&&(f={op:b.POW,args:[f,{op:b.NUM,args:["-1"]}]}),d.push(f);return 1<d.length?{op:b.MUL,args:d}:d[0]}function ta(a){if("number"===typeof a)return-a;if(1===a.args.length){if(a.op===b.SUB)return a.args[0];if(a.op===b.ADD)return a.args[0]=ta(a.args[0]),a}else if(a.op===b.MUL)return a.args.unshift({op:b.NUM,args:["-1"]}),a;return{op:b.MUL,args:[{op:b.NUM,args:["-1"]},a]}}function ra(a){return a===ca||a===E||a===H}function ba(){for(var a=na(),f;ra(f=m);){c();var d=na();switch(f){case H:a={op:b.PM,args:[a,
d]};break;case E:d=ta(d);default:a={op:b.ADD,args:[a,d]}}}return a}function sa(a){return a===fa||a===ga||a===ha||a===ia||a===ja||a===ka}function ua(){for(var a=ba(),b;sa(b=m);){c();var d=ba();switch(b){default:a={op:h[b],args:[a,d]}}}return a}function Z(){for(var a=ua(),b;(b=m)===da;){c();var d=ua(),a={op:h[b],args:[a,d]}}return a}function u(){for(var a=Z(),b=[a];m===F;)c(),b.push(Z());return 1<b.length?{op:h[F],args:b}:a}var y=0,ca=43,C=94,D=95,M=261,P=264,Q=265,G=47,da=61,B=256,R=263,J=123,z=91,
...
h[aa]="exp";h[ka]="to";h[V]="sum";h[W]="int";h[X]="prod";var s=function(a){function b(e){var f=String.fromCharCode(e);for(d+=f;97<=e&&122>=e;){e=a.charCodeAt(c++);var f=String.fromCharCode(e),k=d+f;if(!some(h,function(a){return 0===a.indexOf(k)}))break;d+=f}c--;return t}var c=0,d="",e=[];e["\\times"]=ea;e["\\div"]=G;e["\\dfrac"]=B;e["\\frac"]=B;e["\\sqrt"]=K;e["\\pm"]=H;e["\\sin"]=L;e["\\cos"]=M;e["\\tan"]=N;e["\\sec"]=O;e["\\cot"]=P;e["\\csc"]=Q;e["\\ln"]=R;e["\\lg"]=S;e["\\log"]=T;e["\\left"]=null;
e["\\right"]=null;e["\\big"]=null;e["\\Big"]=null;e["\\bigg"]=null;e["\\Bigg"]=null;e["\\text"]=269;e["\\textrm"]=269;e["\\textit"]=269;e["\\textbf"]=269;e["\\lt"]=fa;e["\\le"]=ga;e["\\gt"]=ha;e["\\ge"]=ia;e["\\exists"]=Y;e["\\in"]=ja;e["\\forall"]=$;e["\\lim"]=U;e["\\exp"]=aa;e["\\to"]=ka;e["\\sum"]=V;e["\\int"]=W;e["\\prod"]=X;var h="g cg kg mg ng m cm km mm nm L mL s cs ks ms ns in ft mi fl cup pt qt gal oz lb".split(" ");return{start:function(){var g;for(d="";c<a.length;)switch(g=a.charCodeAt(c++)){case 32:case 9:case 10:case 13:continue;
case 92:d+=String.fromCharCode(g);g=a.charCodeAt(c++);if(36===g||37===g)d=String.fromCharCode(g);else{for(;97<=g&&122>=g||65<=g&&90>=g;)d+=String.fromCharCode(g),g=a.charCodeAt(c++);c--}g=e[d];if(void 0===g)g=t;else if(269===g){for(g=a.charCodeAt(c++);123!==g;)g=a.charCodeAt(c++);d="";for(g=a.charCodeAt(c++);125!==g;)g=String.fromCharCode(g),d+=g,g=a.charCodeAt(c++);g=t}if(g)return g;d="";continue;case 40:case 41:case 42:case 43:case 44:case 45:case 47:case 61:case 91:case 93:case 94:case 95:case 123:case 125:return d+=
String.fromCharCode(g),g;case 36:case 37:return d+=String.fromCharCode(g),t;default:if(65<=g&&90>=g)return d+=String.fromCharCode(g),t;if(97<=g&&122>=g)return b(g);if(46===g||48<=g&&57>=g){for(;48<=g&&57>=g||46===g;)d+=String.fromCharCode(g),g=a.charCodeAt(c++);c--;return pa}assert(!1,f(1004,[String.fromCharCode(g),g]));return 0}return 0},lexeme:function(){return d},pos:function(){return c}}}(a);return{expr:function(){m=s.start();var a=u();assert(!m,f(1003,[s.pos(),s.lexeme()]));return a}}};return b}();
