...
if(void 0===a)return this.args[b];this.args[b]=a;return this};b.prototype.args=function(b){if(!c(this))throw"Malformed node";if(void 0===b)return this.args;this.args=b;return this};b.prototype.isNode=c;b.intern=b.prototype.intern=function n(l){this instanceof b&&void 0===l&&c(this)&&(l=this);"number"===typeof l?l={op:"num",args:[l.toString()]}:"string"===typeof l&&(l={op:"str",args:[l]});assert("object"===typeof l,"node not an object");for(var w=l.op,r=l.args.length,p="",H=[],k=0;k<r;k++)p="str"===
l.op||"num"===l.op||"var"===l.op?p+(H[k]=l.args[k]):p+(H[k]=n(l.args[k]));l=w+r+p;r=a[l];void 0===r&&(f.push({op:w,args:H}),r=f.length-1,a[l]=r);return r};b.prototype.node=function(b){b=JSON.parse(JSON.stringify(f[b]));create(b);switch(b.op){case "num":case "str":case "var":break;default:for(var a=0;a<b.args.length;a++)b.args[a]=this.node(b.args[a])}return b};b.dumpAll=b.prototype.dumpAll=function(){var a="";forEach(f,function(c,f){a+="\n"+f+": "+b.dump(c)});return a};b.dump=b.prototype.dump=function l(b){if("string"===
...
{op:"var",args:[s.lexeme()]};c();break;case 97:a={op:"var",args:[s.lexeme()]};c();break;case pa:a={op:"num",args:[s.lexeme()]};c();break;case wa:case y:d(q);a=u();d(tk2=m===I?I:z);2===a.args.length||q!==y&&tk2!==z||assert(!1,f(1002));a.lbrk=q;a.rbrk=tk2;break;case J:a=n();break;case A:c();q=n();a=n();a={op:b.MUL,args:[q,{op:b.POW,args:[a,{op:b.NUM,args:["-1"]}]}]};break;case K:c();switch(m){case y:d(y);q=u();d(z);a=n();a={op:b.POW,args:[a,q,{op:b.NUM,args:["-1"]}]};break;case J:a=n();a=a.op===b.POW?
{op:b.POW,args:[a.args[0],{op:b.MUL,args:[a.args[1],{op:b.POW,args:[{op:b.NUM,args:["2"]},{op:b.NUM,args:["-1"]}]}]}]}:{op:b.POW,args:[a,{op:b.NUM,args:["2"]},{op:b.NUM,args:["-1"]}]};break;default:assert(!1,f(1001,["{ or (",String.fromCharCode(m)]))}break;case L:case M:case N:case O:case P:case Q:c();for(a=[];m===B;)c(),a.push(v());a.unshift({op:h[q],args:[e()]});return 1<a.length?{op:b.POW,args:a}:a[0];case R:return c(),{op:b.LOG,args:[{op:b.VAR,args:["e"]},e()]};case S:return c(),{op:b.LOG,args:[{op:b.NUM,
args:["10"]},e()]};case T:return c(),a=[],m===C?(c(),a.push(e())):a.push({op:b.VAR,args:["e"]}),a.push(e()),{op:b.LOG,args:a};case U:return c(),a=[],d(C),a.push(e()),a.push(e()),{op:h[q],args:a};case V:case W:case X:return c(),a=[],m===C&&(c(),a.push(e()),d(B),a.push(e())),a.push(u()),{op:h[q],args:a};case Y:return c(),{op:b.EXISTS,args:[Z()]};case $:return c(),{op:b.FORALL,args:[u()]};case aa:return c(),{op:b.EXP,args:[ba()]};default:assert(!1,"Model.primaryExpr() unexpected expression kind "+s.lexeme()),
a=void 0}return a}function n(){d(J);var b=u();d(qa);return b}function v(){var a;switch(m){case ca:c();a=v();break;case D:c();a=v();a={op:b.SUB,args:[a]};break;default:switch(a=e(),m){case ra:c(),a={op:b.PERCENT,args:[a]}}}return a}function la(){for(var a=[v()];m===C;)c(),a.push(v());return 1<a.length?{op:b.SUBSCRIPT,args:a}:a[0]}function ma(){for(var a=[la()];m===B;)c(),a.push(la());return 1<a.length?{op:b.POW,args:a}:a[0]}function na(){for(var a,f,d=[ma()];(a=m)&&!sa(a)&&!ta(a)&&a!==E&&a!==da&&a!==
qa&&a!==I&&a!==z;)a!==ea&&a!==F||c(),f=ma(),a===F&&(f={op:b.POW,args:[f,{op:b.NUM,args:["-1"]}]}),d.push(f);return 1<d.length?{op:b.MUL,args:d}:d[0]}function ua(a){if("number"===typeof a)return-a;if(1===a.args.length){if(a.op===b.SUB)return a.args[0];if(a.op===b.ADD)return a.args[0]=ua(a.args[0]),a}else if(a.op===b.MUL)return a.args.unshift({op:b.NUM,args:["-1"]}),a;return{op:b.MUL,args:[{op:b.NUM,args:["-1"]},a]}}function sa(a){return a===ca||a===D||a===G}function ba(){for(var a=na(),f;sa(f=m);){c();
var d=na();switch(f){case G:a={op:b.PM,args:[a,d]};break;case D:d=ua(d);default:a={op:b.ADD,args:[a,d]}}}return a}function ta(a){return a===fa||a===ga||a===ha||a===ia||a===ja||a===ka}function va(){for(var a=ba(),b;ta(b=m);){c();var d=ba();switch(b){default:a={op:h[b],args:[a,d]}}}return a}function Z(){for(var a=va(),b;(b=m)===da;){c();var d=va(),a={op:h[b],args:[a,d]}}return a}function u(){for(var a=Z(),b=[a];m===E;)c(),b.push(Z());return 1<b.length?{op:h[E],args:b}:a}var x=0,ca=43,B=94,C=95,M=261,
P=264,Q=265,F=47,da=61,A=256,R=263,J=123,y=91,wa=40,ea=42,pa=48,G=258,qa=125,z=93,I=41,O=262,L=259,K=257,D=45,N=260,t=97,E=44,S=267,T=268,fa=270,ga=271,ha=272,ia=273,Y=274,ja=275,$=276,U=277,aa=278,ka=279,V=280,W=281,X=282,ra=37,h=[],m=x,oa=x;h[A]="frac";h[K]="sqrt";h[ca]="+";h[D]="-";h[G]="pm";h[B]="^";h[ea]="times";h[F]="frac";h[L]="sin";h[M]="cos";h[N]="tan";h[O]="sec";h[P]="cot";h[Q]="csc";h[R]="ln";h[S]="lg";h[T]="log";h[da]="=";h[E]=",";h[269]="text";h[fa]="lt";h[ga]="le";h[ha]="gt";h[ia]="ge";
h[Y]="exists";h[ja]="in";h[$]="forall";h[U]="lim";h[aa]="exp";h[ka]="to";h[V]="sum";h[W]="int";h[X]="prod";var s=function(a){function b(e){var f=String.fromCharCode(e);for(d+=f;97<=e&&122>=e;){e=a.charCodeAt(c++);var f=String.fromCharCode(e),k=d+f;if(!some(h,function(a){return 0===a.indexOf(k)}))break;d+=f}c--;return t}var c=0,d="",e=[];e["\\times"]=ea;e["\\div"]=F;e["\\dfrac"]=A;e["\\frac"]=A;e["\\sqrt"]=K;e["\\pm"]=G;e["\\sin"]=L;e["\\cos"]=M;e["\\tan"]=N;e["\\sec"]=O;e["\\cot"]=P;e["\\csc"]=Q;
